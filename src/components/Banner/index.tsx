...
import bannerMobile from '@assets/banner_sm.webp';
import bannerWeb from '@assets/banner_xl.webp';
        ...
        <StyledBanner className="SG-banner sm-flex align-sm-center">
            ...
            <div className="SG-banner__order sm-w50 relative">
                <SoundEqualizer audioRef={audioRef} isPlaying={isPlaying}>
                    <ResponsiveImage assetWeb={bannerWeb} assetMobile={bannerMobile} alt="bannerTitle" />
                </SoundEqualizer>
            </div>
        </StyledBanner>
    );
